...
Score.innerHTML=` You Scored ${ActualScore}%`
...
Answers.style.zIndex = `7`
for (let i = 0; i < data.length; i++) {
let html = `<div>
<h4>${data[i].question}</h4>
<p>${data[i].correct}</p>
</div>`
document.getElementsByClassName(`ans`)[0].insertAdjacentHTML(`beforeend`,html)
document.getElementsByClassName(`ans`)[0].style.marginBottom = `20px`
}
}